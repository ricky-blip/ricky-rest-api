...
public class ResUnvalidatedSalesOrderDTO {
	...
	public ResUnvalidatedSalesOrderDTO(Long idSalesOrder, String noFaktur, String namaCustomer, String transactionType, BigDecimal totalHarga) {
	...
	// Getter & Setter
	public Long getIdSalesOrder() { return idSalesOrder; }
	public void setIdSalesOrder(Long idSalesOrder) { this.idSalesOrder = idSalesOrder; }
